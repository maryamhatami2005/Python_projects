...
## Introduction
This project aimed to evaluate the efficiency of three key sorting algorithms: Bubble Sort, Insertion Sort, Selection Sort, and Merge Sort. The goal of this project was to assess these algorithms' suitability under different conditions, i.e., different input sizes.
...
├── merge_sort.py                                   # module implementing the Selection Sort algorithm
